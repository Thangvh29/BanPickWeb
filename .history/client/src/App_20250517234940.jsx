...
function App() {
  ...
  const handleBanPick = async (weaponId, action) => {
    try {
      ...
      throw error; // Để WeaponGrid.jsx xử lý lỗi
    }
  };
          ...
          <Row>
            ...
            <Col md={6}>
                ...
                <Row className="mb-3">
                  <Col>
                    <WeaponSelectionPanel
                      ...
                      disabled={sessionData?.readyStatus?.player1Ready}
                    />
                  </Col>
                  <Col xs="auto" className="align-self-end">
                    <Button variant="success" onClick={handlePrepare} disabled={sessionData?.readyStatus?.player1Ready}>
                      Chuẩn bị
                    </Button>
                  </Col>
                  <Col xs="auto" className="align-self-end">
                    <Button variant="warning" onClick={handleUnlock}>
                      Mở khóa
                    </Button>
                  </Col>
                </Row>
              ...
              {locked && user === 'player2' && !started && (
                <Row className="mb-3">
                  <Col xs="auto">
                    <Button variant="success" onClick={handlePrepare} disabled={sessionData?.readyStatus?.player2Ready}>
                      Chuẩn bị
                    </Button>
                  </Col>
                </Row>
